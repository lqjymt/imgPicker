 ...
 * 图片和视频在同一个fragment展示
 */
public class ChooseImageFragment extends Fragment implements
    ...
    AlbumImageCollection.AlbumCallbacks {
    ...
    private void initView(View mRootView) {
        mContainer = mRootView.findViewById(R.id.fragment_container);
    ...
    private void onAlbumSelected(Album album) {
        ...
        if (album.isAll() && album.isEmpty()) {
            ...
            fragment = PhotoSelectionFragment.newInstance(album);
           getChildFragmentManager()
                    .beginTransaction()
                    .add(R.id.fragment_container, fragment, PhotoSelectionFragment.class.getSimpleName())
