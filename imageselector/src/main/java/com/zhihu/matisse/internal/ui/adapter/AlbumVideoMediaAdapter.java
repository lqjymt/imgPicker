...
public class AlbumVideoMediaAdapter extends
    ...
    private final SelectedVideoItemCollection mSelectedCollection;
    ...
    public AlbumVideoMediaAdapter(Context context, SelectedVideoItemCollection selectedCollection, RecyclerView recyclerView) {
        super(null);
