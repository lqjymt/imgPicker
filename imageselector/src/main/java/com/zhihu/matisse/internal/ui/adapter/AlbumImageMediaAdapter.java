...
public class AlbumImageMediaAdapter extends
    ...
    private final SelectedImageItemCollection mSelectedCollection;
    ...
    public AlbumImageMediaAdapter(Context context, SelectedImageItemCollection selectedCollection, RecyclerView recyclerView) {
        super(null);
